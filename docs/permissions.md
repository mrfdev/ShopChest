...
| `shopchest.update` | `op` | Uses `/shops update`. |
...
No permission is required for `/shops`, `/shops info`, `/shops limits`, `/shops inspect`, or managing a player's own normal shop after it has been created.
