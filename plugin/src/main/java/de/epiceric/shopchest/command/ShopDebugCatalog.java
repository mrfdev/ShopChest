    ...
    static List<CommandEntry> commands(String command) {
        ...
        return List.of(
                ...
                new CommandEntry(root + " search <item> [page]",
                        "Finds scoped customer-buy offers, including visibly unchecked chunks.",
                        "shopchest.search"),
                new CommandEntry(root + " profile [shops [page]] | profile shopowner <player|uuid> [shops [page]]",
                ...
                new CommandEntry(root + " profile <set|clear|featured> ...",
                        ...
                        "shopchest.profile"),
                new CommandEntry(root + " profile display <create|remove|status>",
                        "Manages one persistent Ender Chest-anchored Storefront Display.",
                        "shopchest.profile"),
                ...
                new CommandEntry(root
                        ...
                        "Moderates public profile text, eligibility, and persistent displays.",
