...
public class MessageRegistryLoader {
    ...
    private void registerAll(@NotNull String[] messages) {
        ...
        register(messages, Message.HELP_COMMAND_ADMIN, "message.help.command.admin", "&a/%COMMAND% admin list <player> [page] &7- List and teleport to a player's shops. &8[shopchest.admin.list]");
        ...
        register(messages, Message.SHOP_LIST_ENTRY, "message.shopList.entry", "&e#%SHOP-ID% &f%AMOUNT% x %ITEMNAME% &8- &b%WORLD% &7(%X%, %Y%, %Z%)");
        ...
        register(messages, Message.ADMIN_HELP_LIST, "message.admin.list", "&a/%COMMAND% admin list <player> [page] &7- List every registered shop and click a row to teleport.");
